...
This book is a **step-by-step guide to easily and correctly producing SPC charts**. Since this involves statistics, computing, and visualisation, our software of choice is **R** -- often referred to as the *lingua franca* of statistical computing and visualization.

What makes this book unique is its **specialised, practical, and modern approach**, specifically tailored for data scientists and practitioners in the healthcare sector. Here's what you can expect:

1. **Target audience**<br>
This book is for anyone looking to produce SPC charts using modern tools. While it is specifically geared toward **data scientists**, we recognise that our readers may include analysts, practitioners, managers, educators, students, researchers, clinicians, or even patients. Regardless of your role, if you work with healthcare data and want to master SPC, then this book is for you.

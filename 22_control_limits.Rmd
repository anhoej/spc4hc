...
The MR chart plots the moving ranges of individual values. It is a companion to the I chart. Since moving ranges may be zero but cannot be negative, the MR chart has no lower control limit.
...
```{r, echo=FALSE, file='R/constants.R'}
```

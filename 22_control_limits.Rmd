...
read.delim("input/limit_formulas.tsv", check.names = FALSE) |>
  kbl(
    caption = "Formulas for calculating control limits",
    booktabs = TRUE,
    escape = FALSE
  ) |>
...
For this section, we use the [Ceasearian section delay] dataset on response times for 208 grade 2 caesarean sections, that is, the time in minutes from the decision to perform the caesarean section until the baby was delivered. The aim is to keep this delay below 30 minutes.

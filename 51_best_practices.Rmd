...
In practice, however, routine data are often insufficient for SPC analysis. Key variables may be missing, recorded inconsistently, or saved as unstructured data -- for example, as free text rather than structured information -- making it difficult to construct meaningful SPC charts. This frequently creates a need for supplementary procedures specifically designed to capture the necessary information.

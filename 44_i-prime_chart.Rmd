...
```{r iprime-fig1, out.width='50%', fig.show='hold', fig.cap="Comparing I' and P' charts"}
...
I' charts produce results similar to the original I chart for individual measurements, and to the P' and U' charts for proportion and count data.
...
We, however, see no reason that I' charts cannot be used for data with multiple measurements per subgroup instead of X-bar charts.


Only one thing prevents us from fully recommending I' charts as the solution to all our charting needs -- we, ourselves, have limited experience with I' charts, which makes us hesitant to make solid recommendations without further evidence. However, this will change in the future, and I' charts may be the new Swiss Army Knife of SPC.

...
There are many different types of control charts and the chart to be used is determined mostly by the type of data to be plotted. But regardless of the type of data, SPC charts look the same and are interpreted the same.
...
Before we get to the rules in Chapter \@ref(testing), we will take a close look at the structure and the functionality of SPC charts.

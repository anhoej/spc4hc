...
Critical values for longest runs and number of crossings for 10-100 data points are given in Appendix \@ref(runs-limits). For example, in a run chart with 24–26 useful observations (i.e. data points not on the centre line), a longest run of *more* than eight points or *fewer* than eight crossings signals a shift in the data.

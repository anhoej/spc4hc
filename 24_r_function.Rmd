...
We will not go through each of these functions in detail, but we encourage you to study them to get a good grasp of how they work and work together. And we encourage you to improve and adapt them to your needs. 
...
* Also, we no longer have to use the clumsy $-notation or `with()` functions to access variables inside a data frame. Instead, we may pass the name of the data frame to the `data` argument.
...
Here are examples of each of the Magnificent Eight. See the source code at the end of this chapter for documentation of the input arguments.
...
### X-bar and S charts for averages and standard deviations af measurements

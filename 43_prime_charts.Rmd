...
Figure \@ref(fig:pcharts-fig1) demonstrates this phenomenon, known as overdispersion, using data from from @mohammed2013 (example data are tabulated at the [end of this chapter](#pp-data)).
...
Laney proposed a solution that adjust the within subgroup variation in count data ($\sigma_{pi}$) by a factor based on the moving ranges of successive standardised data points ($\sigma_z$) [@laney2002].

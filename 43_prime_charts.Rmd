...
Note that in qicharts2, the moving ranges of the standardised values are, by default, screened for extreme values -- following the same approach used for I charts, as described in Chapter \@ref(screenedmr).

...
Figure \@ref(fig:pcharts-fig1) demonstrates this phenomenon, known as overdispersion, using data from from @mohammed2013 included in *qicharts2* (nhs_accidents). The data are tabulated at the end of this chapter.

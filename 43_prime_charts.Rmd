...
Laney proposed a solution that adjust the assumed within subgroup variation in count data by a factor based on the moving ranges of successive standardised data points ($\sigma_z$) [@laney2002].

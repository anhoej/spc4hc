...
SPC is all about understanding variation and recognising the underlying causes -- common or special -- in order to help improve products and services. Contrary to many beliefs SPC is *not* simply a method of identifying outliers in a population.
...
With this insight in mind, the rest of this book is mostly about the tools -- in particular the SPC chart, which is a simple and intuitive graphical representation of process variation over time. In the next chapter we take a close look at the "anatomy and physiology" of SPC charts.

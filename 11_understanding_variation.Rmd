...
Imagine writing the letter a by hand using pen and paper. Figure @ref(fig
) shows eight instances of this letter written by one of the authors. The first seven letters were produced with the dominant (right) hand, while the last one was written with the non-dominant hand.
...
Now consider the rightmost letter in Figure @ref(fig), produced with the non-dominant hand. Its marked difference from the others suggests a special cause. Special cause variation arises from factors external to the usual process and requires investigation. When encountering special cause variation, the response involves detective work to identify the underlying cause.
...
The handwritten letters exemplify two types of variation:

Common Cause Variation
Intrinsic to the process, this variation is stable and predictable within a range. Addressing it requires systemic changes to the process as a whole.

Special Cause Variation
Arising from external factors, this variation is unpredictable and requires investigation. The response depends on whether the variation is beneficial or harmful.
...
With this foundation in mind, the rest of this book focuses on the tools of SPC, particularly the SPC chart. In the next chapter, we delve into the “anatomy and physiology” of SPC charts, exploring their structure, function, and practical applications.

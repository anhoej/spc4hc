...
Recently we introduced two simple rules that rely only on the distribution of data points around the centre line, the shift and crossings rules that look for unusually long runs of data points on the same side of the centre line or unusually few crossings of the centre line (@anhoej2014).

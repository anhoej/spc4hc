...
Note that we suppressed the plotting and assigned the (invisible) output, which is a data frame containing the coordinates to plot, to the variable 'p'. We can now continue working with p as with any other R object.

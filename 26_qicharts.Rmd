...
Figure \@ref(fig:qicharts-hais1) shows the total (aggregated) monthly counts of hospital infections from six hospitals.
...
Figure \@ref(fig:qicharts-hais2) shows the data as Figure \@ref(fig:qicharts-hais1), but this time data have been stratified into so-called small multiple plots -- one plot per hospital.
...
Finally, we may want to display both dimensions, infection and hospital at the same time (Figure \@ref(fig:qicharts-hais5).
...
qic(month, n, days, 
    ...
    chart    = 'u',
    multiply = 10000,
    facets   = infection ~ hospital,         # two-dimensional faceting by infection and hospital
    scales   = 'free_y',
    title    = 'Hospital infections',
    ylab     = 'Count per 10,000 risk days',
    xlab     = 'Month')

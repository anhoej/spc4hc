...
Probability is a measure of the likelihood of the occurrence of a given event and is central to statistics.
...
Probability is fundamental to SPC because *through the use of past experience, we can predict, within limits, how the phenomenon may be expected to vary in the future* [@shewhart1931, p. 6].

In this context, *past experience* may derive from empirical observations, theoretical considerations, or both, regarding the distribution and variability of data collected over time. This is the topic for the rest of this chapter.
